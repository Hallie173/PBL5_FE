...
import { useAttractionList } from "./hooks/useAttractionList";
...
const AttractionList = () => {
  ...
  const handleCardClick = useCallback(
    (id) => navigate(`/tripguide/attraction/${id}`),
    [navigate]
  );
      ...
      <Container maxWidth="xl" sx={{ pt: 4 }}>
        ...
        <Box sx={{ textAlign: "center", mb: 4 }}>
          ...
          <Typography variant="h6" color="#64748b" sx={{ fontWeight: 400 }}>
            Search and explore amazing places to visit
          </Typography>
        </Box>
              ...
              <>
                ...
                <Box>
                  {attractions.map((attraction, index) => (
                    <Box sx={{ mb: 3 }} key={attraction.attraction_id}>
                      <ItemCard
                        item={attraction}
                        index={index}
                        page={page}
                        limit={12}
                        onClick={() =>
                          handleCardClick(attraction.attraction_id)
                        }
                        type="attraction"
