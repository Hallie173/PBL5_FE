...
export default function RestaurantReview() {
  ...
  return (
    <>
      {/* Full-screen loading */}
      {isLoading && <Loading message="Loading restaurant details..." />}
          ...
          <div className="md:w-1/3 p-6 bg-gray-50 border-r border-gray-200">
            ...
            {isLoading ? (
              ...
              <div
                ...
                aria-label={`Details for ${locationData?.name || "restaurant"}`}
              >
                <div className="mb-4 w-full overflow-hidden rounded-lg shadow-sm relative group">
                  <img
                    ...
                    alt={locationData?.name || "Restaurant"}
                ...
                <div className="text-center w-full">
                  ...
                  >
                    {locationData?.name || "Unknown Restaurant"}
                  </div>
                </div>
              </div>
            )}
            ...
            {!isLoading && !fetchError && (
              <form onSubmit={formik.handleSubmit}>
                ...
                <div className="mb-6">
                  ...
                  <ErrorMessage name="purpose" formik={formik} />
                </div>
